#Requires -Version 3.0 
 ...
 #Requires -Module Azure.Storage 
     ...
     [string] $ResourceGroupName = "rg_IndigoTest_01"
     [switch] $UploadArtifacts
     [string] $StorageAccountName
      [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + "-stageartifacts"      
      
      [string] $TemplateFile = "C:\GitRepos\Indigo\Source\IndigoARMTemplate\azuredeploy.json"
       [string] $TemplateParametersFile = "C:\GitRepos\Indigo\Source\IndigoARMTemplate\azuredeploy.parameters.json"
