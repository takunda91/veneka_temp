...
BEGIN
	...
	FROM
		...
		inner JOIN customer_account_cards ON customer_account_cards.customer_account_id = customer_fields.customer_account_id
	...
	FROM
		...
		inner JOIN customer_account_cards ON customer_account_cards.customer_account_id = customer_image_fields.customer_account_id
		--LEFT JOIN cards ON cards.card_id = customer_account.card_id
	WHERE customer_account_cards.card_id = @card_id
