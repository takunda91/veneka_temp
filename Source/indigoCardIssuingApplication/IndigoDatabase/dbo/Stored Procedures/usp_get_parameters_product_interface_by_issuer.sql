...
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[usp_get_parameters_product_interface_by_issuer] 
...
BEGIN
	...
	WHERE product_interface.product_id IN (SELECT product_id FROM [issuer_product] WHERE issuer_id = @issuer_id)
