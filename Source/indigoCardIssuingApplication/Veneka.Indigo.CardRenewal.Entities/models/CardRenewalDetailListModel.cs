...
namespace Veneka.Indigo.CardRenewal.Entities
{
    public class CardRenewalDetailListModel
    {
        public long CardRenewalDetailId { get; set; }
        public long CardRenewalId { get; set; }
