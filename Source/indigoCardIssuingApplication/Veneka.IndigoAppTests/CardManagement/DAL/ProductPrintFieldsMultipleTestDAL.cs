...
{
    public class ProductPrintFieldsMultipleTestDAL : ICardManagementDAL
    {
        #region The test data        
        // --------------------------------------------------------------------------------------------------------------------------------------
        private static readonly Tuple<int, List<ProductPrintFieldResult>> _multipleRowsSingleProductTestData = new Tuple<int, List<ProductPrintFieldResult>>(
                1, new List<ProductPrintFieldResult>()
                {
                    new ProductPrintFieldResult()
                    {
                        ...
                        product_field_id = 0, product_id = 1, value = new byte[1] { 1 },
                        width = 15, X = 1, Y = 2
                    },
                    new ProductPrintFieldResult()
                    {
        ...
        /// <summary>
        /// Test data used when product id 1 passed in and card id is null. will return multiple records back
        /// </summary>
        /// <returns></returns>
        public static Tuple<int, List<ProductPrintFieldResult>> MultipleRowsForProductTestData()
        {
            return _multipleRowsSingleProductTestData;
        }

        // --------------------------------------------------------------------------------------------------------------------------------------
        private static readonly Tuple<long, List<ProductPrintFieldResult>> _multipleRowsSingleCardTestData = new Tuple<long, List<ProductPrintFieldResult>>(
                1024, new List<ProductPrintFieldResult>()
                {
                    new ProductPrintFieldResult()
                    {
                        deleted = false, editable = false,
                    ...
                    {
                        deleted = false, editable = false,
                        field_name = "Field name2", font = "Arial", font_size = 10, height = 20,
                        label = "label2", mapped_name = "mappedname2", max_length = 12,
                        print_field_name = "print field name", print_field_type_id = 0,
                        product_field_id = 0, product_id = 1, value = new byte[1] { 1 },
                        width = 15, X = 1, Y = 2
                    },
                    ...
                    {
                        deleted = false, editable = false,
                        field_name = "Field name3", font = "Arial", font_size = 10, height = 20,
                        label = "label3", mapped_name = "mappedname3", max_length = 12,
                        print_field_name = "print field name3", print_field_type_id = 0,
                        product_field_id = 0, product_id = 1, value = new byte[1] { 1 },
                        width = 15, X = 1, Y = 2
                    }
                });
        ...
        /// </summary>
        /// <returns></returns>
        public static Tuple<long, List<ProductPrintFieldResult>> MultipleRowsForCardTestData()
        {
            return _multipleRowsSingleCardTestData;
        }

        // --------------------------------------------------------------------------------------------------------------------------------------
        private static readonly Tuple<int, long, List<ProductPrintFieldResult>> _multipleRowsSingleCardAndProductTestData = new Tuple<int, long, List<ProductPrintFieldResult>>(
                1, 2547, new List<ProductPrintFieldResult>()
                {
                    new ProductPrintFieldResult()
                    {
                        deleted = false, editable = false,
        ...
        /// </summary>
        /// <returns></returns>
        public static Tuple<int, long, List<ProductPrintFieldResult>> MultipleRowsForProductAndCardTestData()
        {
            return _multipleRowsSingleCardAndProductTestData;
        }
        // -----------------------------------------------------------------------------------------------------------------------

        private static readonly Tuple<int, long, List<ProductPrintFieldResult>> _multipleRowsTestData = new Tuple<int, long, List<ProductPrintFieldResult>>(
            1, 4467, new List<ProductPrintFieldResult>()
            {
                    new ProductPrintFieldResult()
                    {
                        deleted = false, editable = false,
                    ...
                    {
                        deleted = false, editable = false,
                        field_name = "Field name22", font = "Arial", font_size = 10, height = 20,
                        label = "label22", mapped_name = "mappedname22", max_length = 12,
                        print_field_name = "print field name22", print_field_type_id = 0,
                    ...
                    new ProductPrintFieldResult()
                    {
                        ...
                        field_name = "Field name2", font = "Arial", font_size = 10, height = 20,
                        label = "label2", mapped_name = "mappedname2", max_length = 12,
                        print_field_name = "print field name2", print_field_type_id = 0,
                        product_field_id = 0, product_id = 2, value = new byte[1] { 1 },
                        width = 15, X = 1, Y = 2
                    },
                    new ProductPrintFieldResult()
                    {
                        ...
                        label = "label3", mapped_name = "mappedname3", max_length = 12,
                        print_field_name = "print field name3", print_field_type_id = 0,
                        product_field_id = 0, product_id = 3, value = new byte[1] { 1 },
                        width = 15, X = 1, Y = 2
                    }
            });

        /// <summary>
        /// Test data used when product id is null and card id is null. will return multiple records back
        /// </summary>
        /// <returns></returns>
        public static Tuple<int, long, List<ProductPrintFieldResult>> MultipleRowsTestData()
        {
            return _multipleRowsTestData;
        }
        // -----------------------------------------------------------------------------------------------------------------------
        #endregion

        /// <summary>
        /// Will return multiple rows no mater what is passed in
        /// </summary>
        ...
        public List<ProductPrintFieldResult> GetProductPrintFields(long? productId, long? cardId)
        {
            ...
            {
                return MultipleRowsTestData().Item3;
            }

            // product data
            if(productId != null && productId == 1 && cardId == null)
            {
                return MultipleRowsForProductTestData().Item2;
            }

            // card data
            if (cardId != null && cardId == 1 && productId == null)
            {
                return MultipleRowsForCardTestData().Item2;
            }

            // both card and product
            if (cardId == 1 && productId == 1)
            {
                return MultipleRowsForProductAndCardTestData().Item3;
            }
