...
public static class CryptoHelper
{
    ...
    public static readonly string PublicKeyPath = Path.Combine(SystemConfiguration.Instance.GetBaseConfigDir(), @"config\PublicKey.txt");
    //ConfigurationManager.AppSettings["PrivateKeyOnly"]
    private static readonly string PrivateKeyOnlyPath = Path.Combine(SystemConfiguration.Instance.GetBaseConfigDir(), @"config\PrivateKey.txt");
    ...
    public static string DecryptPgpData(Stream inputStream, string outputpath)
    {
        string output;
        ...
        {
            output = DecryptPgpData(inputStream, keyIn, Password, outputpath);
        }
        // }
        return output;
    }

    public static string DecryptPgpData(Stream inputStream, Stream privateKeyStream, string passPhrase, string outputpath)
    {
        string output;
