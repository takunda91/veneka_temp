...
{
   public class PrintBatchRequestDetails :  HybridRequestResult
    {
        public PrintBatchRequestDetails() { }


        public PrintBatchRequestDetails(HybridRequestResult cardDetailResult)
        {
