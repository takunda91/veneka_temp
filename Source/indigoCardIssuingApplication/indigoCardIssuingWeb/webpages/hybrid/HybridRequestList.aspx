<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="HybridRequestList.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.hybrid.HybridRequestList" Culture="auto:en-US" meta:resourcekey="PageResource" UICulture="auto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblRequestList" Text="Request List" runat="server" meta:resourcekey="lblRequestListResource" />
            </div>

            <asp:DataList ID="dlRequestList" runat="server"
                ...
                <HeaderTemplate>
                    <tr style="font-weight: bold">
                        ...
                        <td>
                            <asp:Label ID="lblRequestReferenceNumber" runat="server" Text="Request Reference Number" meta:resourcekey="lblRequestReferenceNumberResource" />
                        </td>
                        <td>
                            <asp:Label ID="lblRequestStatus" runat="server" Text="Request Status" meta:resourcekey="lblRequestStatusResource" />
                        </td>
                        <td>
                ...
                <ItemTemplate>
                    ...
                    <tr class="ItemSelect">
                        <td>
                            <asp:Label ID="lblRequestId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "request_id") %>' Visible="false" />
                            <asp:LinkButton ID="lbtnRequestNumber" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "request_reference") %>' CssClass="ItemSelect" />
                        </td>
                       
                        <td>
                            <asp:Label ID="lblRequestStatus" runat="server" CommandName="select" Text='<%# DataBinder.Eval(Container.DataItem, "current_card_status") %>' />
                        </td>
                        <td>
                            <asp:Label ID="lblLastUpdated" runat="server" CommandName="select" Text='<%# DataBinder.Eval(Container.DataItem, "status_date")%>' />
                        </td>
                        <td>
