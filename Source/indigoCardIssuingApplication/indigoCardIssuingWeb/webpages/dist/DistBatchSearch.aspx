<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="DistBatchSearch.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.dist.DistBatchSearch" Culture="auto:en-US" meta:resourcekey="PageResource" UICulture="auto" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblSearchDistributionBatch" runat="server" Text="Batch Search" />
            </div>
