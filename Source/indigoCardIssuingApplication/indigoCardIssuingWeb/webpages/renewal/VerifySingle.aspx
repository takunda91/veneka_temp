<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="VerifySingle.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.renewal.VerifySingle" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            ...
            <asp:Button ID="btnValidateAccount" runat="server" Text="Validate" meta:resourcekey="btnValidateAccountResource"
                CssClass="button" Style="margin: 0px 0px 0px 5px; float: left; height: 26px;"
        ...
        <div id="pnlButtons" class="ButtonPanel" runat="server" visible="false">
            <asp:Button ID="btnConfirm" runat="server" Text="Confirm" CssClass="button" Visible="true" OnClick="btnConfirm_Click" />
