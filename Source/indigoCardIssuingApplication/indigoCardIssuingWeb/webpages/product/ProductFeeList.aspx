<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="ProductFeeList.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.product.ProductFeeList" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContent" runat="server">
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            ...
            <asp:DataList ID="dlFeeSchemeList" runat="server" 
                            OnItemCommand="dlFeeSchemeList_ItemCommand" 
                            Width="100%"
                ...
                <HeaderTemplate>
                    <tr style="font-weight:bold;">
                        <td >
                            <asp:Label ID="lblFeeSchemeNameH" runat="server" Text="Fee Scheme"/>
                        </td>                                      
                        <td >
                ...
                <ItemTemplate>
                    <tr class="ItemSelect">                    
                        <td >
                            <asp:Label ID="lblFeeSchemeId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "fee_scheme_id") %>' Visible="false" />
                            <asp:LinkButton ID="lnkFeeSchemeName"  CommandName="select" Text='<%# DataBinder.Eval(Container.DataItem, "fee_scheme_name") %>' CssClass="ItemSelect" runat="server"  />
                        </td>
                        <td >
