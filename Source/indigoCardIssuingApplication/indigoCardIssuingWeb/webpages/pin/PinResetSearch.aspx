<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="PinResetSearch.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.pin.PinResetSearch" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblSearchPinBatch" runat="server" Text="PIN Reissue Search" />
            </div>  
            ...
            <asp:Label ID="lblBranch" Text="Branch" runat="server" CssClass="label leftclr" Visible="false" />
            <asp:DropDownList ID="ddlBranch" runat="server" CssClass="input rightclr"  Visible="false"/>

            <asp:Label ID="lblPinReissueStatus" runat="server" Text="PIN Reissue Status" CssClass="label leftclr" />
