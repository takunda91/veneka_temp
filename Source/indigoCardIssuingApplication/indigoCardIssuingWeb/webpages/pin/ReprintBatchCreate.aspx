<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="ReprintBatchCreate.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.pin.ReprintBatchCreate" %>

<asp:Content ID="Content6" ContentPlaceHolderID="MainContent" runat="server">
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblCreateBatch" runat="server" Text="Create Pin Mailer Reprint Batch" meta:resourcekey="lblCreateBatchResource" />
            </div>
                        ...
                        <ItemTemplate>
                            <tr class="ItemSelect">
                                ...
                                <td style="height: 25px;">
                                    <asp:Button ID="btnCreate" runat="server" Text="Create" CssClass="button" CommandName="Create" />
                                </td>
                            </tr>
                        </ItemTemplate>
