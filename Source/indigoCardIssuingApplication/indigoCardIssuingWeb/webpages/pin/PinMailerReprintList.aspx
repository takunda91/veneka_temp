<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="PinMailerReprintList.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.pin.PinMailerReprintList" %>

<asp:Content ID="Content6" ContentPlaceHolderID="MainContent" runat="server">
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblCardList" Text="PIN Mailer Reprint Request List" runat="server" meta:resourcekey="lblCardListResource" />
            </div>
            ...
            <asp:DataList ID="dlCardList" runat="server"
                ...
                <ItemTemplate>
                    ...
                    <tr class="ItemSelect">
                        ...
                        <td>
                            <asp:Label ID="lblCardStatus" runat="server" CommandName="select" Text='<%# DataBinder.Eval(Container.DataItem, "current_reprint_status") %>' />
                        </td>
                        <td>
