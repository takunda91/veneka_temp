<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true"
    CodeBehind="PinBatchView.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.pin.PinBatchView" Culture="auto:en-US" meta:resourcekey="PageResource" UICulture="auto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblLoadBatchList" runat="server" Text="Pin Batch Details" meta:resourcekey="lblPinBatchListResource" />
            </div>
        ...
        <div id="pnlButtons" runat="server" class="ButtonPanel">
            ...
            <asp:Button ID="btnReject" runat="server" Text="Received At Card Centre" OnClick="btnReject_OnClick" CssClass="button" />
