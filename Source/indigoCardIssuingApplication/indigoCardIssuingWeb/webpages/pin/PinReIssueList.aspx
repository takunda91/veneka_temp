<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="PinReIssueList.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.pin.PinReIssueList" Culture="auto:en-US" meta:resourcekey="PageResource" UICulture="auto" %>
            ...
            <asp:DataList ID="dlCardList" runat="server"
                ...
                <HeaderTemplate>
                    <tr style="font-weight: bold">
                        ...
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources: CommonLabels, Issuer %>" />
                        </td>
                        <td>
                ...
                <ItemTemplate>
                    ...
                    <tr class="ItemSelect">
                        ...
                        <td>
                            <asp:Label ID="Label2" runat="server" CommandName="select" Text='<%# DataBinder.Eval(Container.DataItem, "pin_request_reference") %>' />
                        </td>
                        <td>
                            <asp:Label ID="Label3" runat="server" CommandName="select" Text='<%# DataBinder.Eval(Container.DataItem, "pin_request_status") %>' />
                        </td>
                        <td>
                            <asp:Label ID="Label4" runat="server" CommandName="select" Text='<%# DataBinder.Eval(Container.DataItem, "pin_create_date", DATETIME_ASPX_FORMAT)%>' />
                        </td>
                        <td>
