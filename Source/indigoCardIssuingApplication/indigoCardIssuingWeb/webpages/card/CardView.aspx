<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="CardView.aspx.cs" Async="true" Inherits="indigoCardIssuingWeb.webpages.card.CardView" Culture="auto:en-US" meta:resourcekey="PageResource" UICulture="auto" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            ...
            <div style="width: 50%; float: left;">
                ...
                <asp:Panel ID="pnlCustomerDetails" runat="server" GroupingText="Customer Details" CssClass="bothclr" meta:resourcekey="lblCustomerDetailsResource1">
                    ...
                    <div id="divEmailAddress" runat="server">
                        <asp:Label ID="Label6" runat="server" Text="Email Address" CssClass="label2col leftclr" meta:resourcekey="lblEmailAddress" />
                        <asp:TextBox ID="tbEmailAddress" runat="server" CssClass="input2col rightclr" MaxLength="350" Enabled="False" />
                    </div>
            ...
            <asp:Panel ID="creditDetailPanel" runat="server" CssClass="bothclr" GroupingText="Credit Card" Visible="false">
                <div style="width: 95%; float: left;">
                    <div id="divCreditLimit" runat="server" visible="false">
                        <asp:Label ID="Label3" runat="server" Text="Credit Limit" CssClass="label leftclr" meta:resourcekey="lblCreditLimit" />
                        <asp:TextBox ID="tbCreditLimit" runat="server" CssClass="input" />
                    </div>
                    <div id="divCreditLimitUpdate" runat="server" visible="false">
                        <asp:Label ID="Label4" runat="server" Text="Review Credit Limit" CssClass="label leftclr" meta:resourcekey="lblCreditLimitUpdate" />
                        <asp:TextBox ID="tbCreditLimitUpdate" runat="server" CssClass="input" OnKeyPress="return isNumberKeyWithPlus(event)" />
                        
                        <div>
                            <asp:RequiredFieldValidator runat="server" ID="reqCreditLimitUpdate" ControlToValidate="tbCreditLimitUpdate"
                                ErrorMessage="Enter credit limit." CssClass="validation rightclr" meta:resourcekey="reqCreditLimitUpdate"></asp:RequiredFieldValidator>
                        </div>
                        <div>
                            <asp:RangeValidator runat="server" ID="rangeValidatorCreditLimit" ControlToValidate="tbCreditLimitUpdate"
                                ErrorMessage="Enter credit limit." CssClass="validation rightclr" meta:resourcekey="reqCreditLimitUpdate"
                                MinimumValue="0.01" MaximumValue="9999999999.99" Type="Double"></asp:RangeValidator>
                        </div>
                    </div>

                    <div id="divCreditContractNumber" runat="server" visible="false">
                        <asp:Label ID="Label5" runat="server" Text="Credit Contract Number" CssClass="label leftclr" meta:resourcekey="lblCreditContractNumber" />
                        <asp:TextBox ID="tbCreditContractNumber" runat="server" CssClass="input" />
                        <asp:RequiredFieldValidator runat="server" ID="reqCreditContractNumber" ControlToValidate="tbCreditContractNumber"
                            ErrorMessage="Please capture the credit contract number." CssClass="validation rightclr" meta:resourcekey="reqCreditContractNumber"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </asp:Panel>

            <div style="width: 95%; float: left;">
                <asp:Label ID="lblSpoilReason" runat="server" Text="Spoil Reason" CssClass="label leftclr" meta:resourcekey="lblSpoilReasonResource" />
        ...
        <asp:Panel ID="documentPanel" runat="server" Visible="false">
            <asp:Panel ID="panelDocuments" runat="server" CssClass="bothclr" GroupingText="Document List">
                <asp:GridView ID="grdDocuments" runat="server" Width="100%"
                    ...
                    DataKeyNames="Id" EmptyDataText="No Rows Returned" OnRowCommand="grdDocuments_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Document Type">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlDocumentType" runat="server" Visible="true" Enabled="false">
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
        ...
        <asp:Panel ID="panelRemoteDocuments" runat="server" Visible="false">
            <asp:Panel ID="panel2" runat="server" CssClass="bothclr" GroupingText="Document List">
                <asp:GridView ID="grdRemoteDocuments" runat="server" Width="100%"
                    ...
                    DataKeyNames="Name" EmptyDataText="No Rows Returned">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                    <HeaderStyle BackColor="White" Font-Bold="True" ForeColor="Black" />
                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                    <Columns>
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl=<%# String.Format("javascript:void(window.open('{0}',null,'left=45px,top=15px, width=300px, height=300px,status=no, resizable= yes, scrollbars=yes, toolbar=no, location=no,menubar=no'))",Eval("Url")) %>><%#Eval("Name") %></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
        ...
        <div id="pnlPrintButtons" class="ButtonPanel" runat="server">
            <asp:Button ID="btnPrint" runat="server" Text="Print " CssClass="btn2col" OnClick="btnPrint_OnClick" OnClientClick="return PrintPanel();" Visible="false" meta:resourcekey="btnPrintResource" />
            <asp:Button ID="btnSdkPrint" runat="server" Text="Emboss Card" OnClientClick="return setFormSubmitToFalse()" CssClass="btn2col " OnClick="btnSdkPrint_OnClick" Visible="false"/>

            <asp:Button ID="btnPrintSuccess" runat="server" Text="Print Success" CssClass="btn2col " OnClick="btnPrintSuccess_OnClick" Visible="false" meta:resourcekey="btnPrintSuccessResource" />
            <asp:Button ID="btnPrintFailed" runat="server" Text="Print Failed" CssClass="btn2col " OnClick="btnPrintFailed_OnClick" Visible="false" meta:resourcekey="btnPrintFailedResource" />
        </div>
        ...
        <div id="pnlActivationButtons" class="ButtonPanel" runat="server">
            <asp:Button ID="btnLinkCardCenter" runat="server" Text="Activate Card" CssClass="button" OnClick="btnLinkCardCenter_OnClick" Visible="false" meta:resourcekey="btnLinkCardCentreResource" />
        </div>

        <div id="pnlButtons" class="ButtonPanel" runat="server">
            <asp:Button ID="btnCreditAnalyst" runat="server" Text="Confirm Credit" CssClass="button" OnClick="btnCreditAnalyst_OnClick" Visible="false" meta:resourcekey="btnCreditAnalystResource" />
            <asp:Button ID="btnCreditManager" runat="server" Text="Confirm Credit" CssClass="button" OnClick="btnCreditManager_OnClick" Visible="false" meta:resourcekey="btnCreditManagerResource" />
            <asp:Button ID="btnCreditContractNumber" runat="server" Text="Set Contract Number" CssClass="button" OnClick="btnCreditContractNumber_Click" Visible="false" meta:resourcekey="btnCreditManagerResource" />
            ...
            <asp:Button ID="btnSpoil" runat="server" Text="<%$ Resources: CommonLabels, Spoil %>" CssClass="button" OnClick="btnSpoil_OnClick" Visible="false" />
            ...
            <asp:Button ID="btnRefresh" runat="server" Text="<%$ Resources: CommonLabels, Refresh %>" CssClass="btn2col" OnClick="btnRefresh_OnClick" />
            <asp:Button ID="btnBack" runat="server" Text="<%$ Resources: CommonLabels, Back %>" CssClass="btn2col" OnClick="btnBack_OnClick" />
        </div>
    </div>
</asp:Content>
