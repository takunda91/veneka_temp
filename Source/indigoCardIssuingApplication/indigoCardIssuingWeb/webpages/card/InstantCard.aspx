<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="InstantCard.aspx.cs" Inherits="indigoCardIssuingWeb.webpages.card.InstantCard" Culture="auto:en-US" meta:resourcekey="PageResource" UICulture="auto" %>
...
<%--            <asp:Label ID="lblDelBranch" runat="server" Text="Delivery Branch" Visible="false" CssClass="label leftclr" />
        ...
        <div id="pnlButtons" class="ButtonPanel" runat="server">
            ...
            <asp:Button ID="btnPrint" runat="server" Text="Print"  CssClass="button" CausesValidation="false" Visible="false"  onclick="btnPrint_OnClick" />
            <asp:Button ID="btnRefresh" runat="server" Text="<%$ Resources: CommonLabels, Refresh %>" CssClass="button" Visible="false" OnClick="btnRefresh_Click" />
                 <asp:Button ID="btnViewCard" runat="server" Text="View Card Details" CssClass="button" Visible="false" OnClick="btnViewCard_Click" />
            </div>
    </div>
