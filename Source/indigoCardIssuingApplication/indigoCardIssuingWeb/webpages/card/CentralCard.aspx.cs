...
{
    public partial class CentralCard : BasePage
    {
        ...
        private void LoadPageData()
        {
            try
            {
                ...
                if (CardIssueMethodId == 2)
                {
                    ...
                    this.ddlReasonForIssue.Visible = true;
        ...
        private void DisplayAllFields(bool showAll)
        {
            ...
            if (CardIssueMethodId == 2 || (CardIssueMethodId == 1 && Satellite_Branch_UserYN))
