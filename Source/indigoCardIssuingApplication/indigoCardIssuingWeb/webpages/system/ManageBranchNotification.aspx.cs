...
{
    public partial class ManageBranchNotification : BasePage
    {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            switch (CurrentPageLayout)
            {
                ...
                case PageLayout.DELETE:
                    ...
                    Server.Transfer("~\\webpages\\system\\BranchNotificationList.aspx");
                    break;
        ...
        private bool DeleteNotification()
        {
            try
            {
                ...
                bool response = _notificationservice.DeleteNotificationBranch(ReadControls(), out responsemessage);
                if (response)
                {

                    Server.Transfer("~\\webpages\\system\\BranchNotificationList.aspx?delete=" + this.ddlIssuer.SelectedValue);
        ...
        private void PopulateFields()
        {
            try
            {
                if (SessionWrapper.Message != null)
                {
                    ...
                    LoadCardIssueMethod(_message.issuerid);
                    ddlStatus.SelectedValue = _message.branchcardstatusesid.ToString();
                    ddlCardIssueMethod.SelectedValue = _message.cardissuemethodid.ToString();
                    ddlchannel.SelectedValue = _message.channel_id.ToString();

                    var notifications = _notificationservice.GetNotificationBranch(ReadControls());

                    pageLayout = PageLayout.READ;
                    ddlIssuer.Enabled =
                   ddlStatus.Enabled =
                   ddlCardIssueMethod.Enabled =
        ...
        private void BuildStatusDropDownList()
        {
            ...
            foreach (var batchStatus in _batchService.LangLookupBranchCardStatuses().OrderBy(o => o.language_text))
            {
        ...
        private void SetControls(bool hideAll)
        {
            ...
            this.ddlCardIssueMethod.Visible =
        ...
        private bool CreateNotification()
        {
            ...
            try
            {
                ...
                if (_notificationservice.InsertNotificationforBranch(GetNotifications(), out responsemessage))
                {
                    pageLayout = PageLayout.READ;
                    return true;
                }
        ...
        private bool UpdateNotification()
        {
            ...
            string responsemessage = string.Empty;
            if (_notificationservice.UpdateNotificationforBranch(GetNotifications(), out responsemessage))
            {
                pageLayout = PageLayout.READ;
                return true;
            }
        ...
        protected NotificationMessages ReadControls()
        {
            ...
            int.TryParse(ddlCardIssueMethod.SelectedValue, out cardissuemethodid);
            message.cardissuemethodid = cardissuemethodid;

            int branchcardstatusid = 0;
            int.TryParse(ddlStatus.SelectedValue, out branchcardstatusid);
            message.branchcardstatusesid = branchcardstatusid;
