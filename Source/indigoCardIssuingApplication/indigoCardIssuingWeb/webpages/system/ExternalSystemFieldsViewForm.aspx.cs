...
{
    public partial class ExternalSystemFieldsViewForm : BasePage
    {
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.txtExternalSystemfieldName.Enabled =
                this.ddlexternalsytem.Enabled = true;
            ...
            try
            {
                ...
                switch (pageLayout)
                {
                    ...
                    case PageLayout.CONFIRM_DELETE:
                        DeleteExternalSystemField();
                        UpdateFormLayout(pageLayout);
                        break;
                    case PageLayout.CONFIRM_UPDATE:
                        if (UpdateExternalSystemField())
                        {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            switch (CurrentPageLayout)
            {
                ...
                case PageLayout.DELETE:
                    Server.Transfer("~\\webpages\\system\\ExternalSystemFieldsManitanance.aspx");
                    break;
        ...
        public int? ExternalSystemFieldId
        {
            get
            {
                if (ViewState["ExternalSystemFieldId"] == null)
                    return null;
                else
                    return Convert.ToInt32(ViewState["ExternalSystemFieldId"].ToString());
            }
            set
            {
                ViewState["ExternalSystemFieldId"] = value;
            }
        }
        #endregion
        ...
        private void LoadPageData()
        {
            try
            {
                ...
                foreach (var role in _issuerMan.GetExternalSystem(null,1,2000).ExternalSystems)
                {
                    externaltypes.Add(new ListItem(role.system_name.ToString(), role.external_system_id.ToString()));
                }
                ddlexternalsytem.Items.AddRange(externaltypes.OrderBy(m => m.Text).ToArray());
        ...
        private void PopulateFields()
        {
            try
            {
                if (SessionWrapper.ExternalSystemFieldId > 0)
                {
                    ExternalSystemFieldId = SessionWrapper.ExternalSystemFieldId;
                    SessionWrapper.ExternalSystemFieldId = 0;
                    if (ExternalSystemFieldId != 0)
                    {
                        var externalsystemfields = _issuerMan.GetExternalSystemsFields((int)ExternalSystemFieldId,1,2000);

                        if (externalsystemfields != null && externalsystemfields.Count > 0)
                        {
                            txtExternalSystemfieldName.Text = externalsystemfields[0].field_name;
                            ddlexternalsytem.SelectedValue = externalsystemfields[0].external_system_field_id.ToString();
                        }
        ...
        private bool DeleteExternalSystemField()
        {
            try
            {
                string responsemessage = string.Empty;
                bool response = _issuerMan.DeleteExternalSystemField(ExternalSystemFieldId, out responsemessage);
                if (response)
                {

                    Server.Transfer("~\\webpages\\system\\ExternalSystemFieldsManitanance.aspx?delete=" + txtExternalSystemfieldName.Text);
        ...
        {
            this.txtExternalSystemfieldName.Enabled =
            this.ddlexternalsytem.Enabled = false;
        ...
        private void SetControls(bool hideAll)
        {
            ...
            this.txtExternalSystemfieldName.Enabled =
                this.ddlexternalsytem.Enabled = enabled;

            this.txtExternalSystemfieldName.Visible =
                this.ddlexternalsytem.Visible = visable;
        }
        #endregion

        #region Helper Methods
       private ExternalSystemFieldsResult ReadControlValues()
        {
            ExternalSystemFieldsResult externalsystem = new ExternalSystemFieldsResult();
            if (ExternalSystemFieldId != 0 && ExternalSystemFieldId!=null)
           {
               externalsystem.external_system_field_id = (int)ExternalSystemFieldId;
           }
            int external_system_id = Convert.ToInt32(this.ddlexternalsytem.SelectedValue);
            externalsystem.field_name = txtExternalSystemfieldName.Text;
            externalsystem.external_system_id = external_system_id;

            return externalsystem;
        }

        private bool CreateExternalSystemField()
        {
            try
            {


                string responsemessage; int external_system_type_id;
                if (_issuerMan.CreateExternalSystemFields(ReadControlValues(), out external_system_type_id, out responsemessage))
                {
                    ExternalSystemFieldId = external_system_type_id;
                    pageLayout = PageLayout.READ;
                    return true;
                }
                else
        ...
        private bool UpdateExternalSystemField()
        {
            
            string responsemessage = string.Empty;

            if (_issuerMan.UpdateExternalSystemFields(ReadControlValues(), out responsemessage))
            {
                pageLayout = PageLayout.READ;
                return true;
            }
