...
{
    public partial class UserPendingList : ListPage
    {
        ...
        private readonly UserRole[] userRolesForPage = new UserRole[] { UserRole.USER_AUDIT };
        ...
        protected void dlUserList_ItemCommand(Object sender, DataListCommandEventArgs e)
        {
            try
            {
                    ...
                    !String.IsNullOrWhiteSpace(userDetails))
                {
                    ...
                    SessionWrapper.SelectedPendingUserId = userId;
        ...
        protected override void DisplayResults(ISearchParameters parms, int pageIndex, object[] results)
        {
            ...
            if (results == null)
            {
                    ...
                    results = userMan.GetUserPendingForApproval(userSearchParms, pageIndex, StaticDataContainer.ROWS_PER_PAGE).ToArray();
