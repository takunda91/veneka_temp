<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="BurnRateReportPage.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.Branches.BurnRateReportPage" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="Burn Rate Report" meta:resourcekey="lblheadingResource" />
            </div>
            <table width="60%">
                  <tr>
