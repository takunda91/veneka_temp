...
{
    public partial class CardDispatchReport : BasePage
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(CardDispatchReport));
        ...
        private readonly UserRole[] userRolesForPage = new UserRole[] { UserRole.REPORT_ADMIN,UserRole.CENTER_MANAGER,UserRole.CENTER_OPERATOR,
                                                                        UserRole.AUDITOR};
        ...
        private void PrepareReportData()
        {
            try
            {
                ...
                //if (this.ddlissuerlist.SelectedValue != "-99")
                //    issuerId = int.Parse(this.ddlissuerlist.SelectedValue);

                //if (this.ddlbranch.SelectedValue != "-99")
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "18"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/CardDispatchReport"; //Passing the Report Path                
