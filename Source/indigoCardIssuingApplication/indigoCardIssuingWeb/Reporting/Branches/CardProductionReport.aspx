<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="CardProductionReport.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.Branches.CardProductionReport" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="Card Production Report" meta:resourcekey="lblheadingResource" />
            </div>
            <table width="60%">
                <tr>
