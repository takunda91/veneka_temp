...
{
    public partial class FeeStatusReport : BasePage
    {
        ...
        private void PrepareReportData(DateTime? startDate, DateTime? endDate, string branchOperator)
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("user_id", userid));
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "27"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/FeeStatusReport"; //Passing the Report Path                
