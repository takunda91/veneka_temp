<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true"
    CodeBehind="FeeRevenueReportPage.aspx.cs" Culture="auto:en-US" meta:resourcekey="PageResource"
    UICulture="auto" Inherits="indigoCardIssuingWeb.Reporting.Branches.FeeRevenueReportPage" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="Fee Revenue Report" meta:resourcekey="lblheadingResource" />
            </div>            
            <table width="60%">
                 <tr>
          ...
          <%--  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetCards" 
                                  TypeName="indigoCardIssuingWeb.App_Code.FeeRevnueReportBo" />
            <asp:ObjectDataSource ID="ObjectDataSourceLables" runat="server" SelectMethod="GetReportLabels" 
                                TypeName="indigoCardIssuingWeb.App_Code.FeeReVenueReportingLables" />--%>
