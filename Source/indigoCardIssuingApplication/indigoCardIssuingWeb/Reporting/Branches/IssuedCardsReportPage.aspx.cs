...
{
    public partial class IssuedCardsReportPage : BasePage
    {
        ...
        private readonly UserRole[] userRolesForPage = new UserRole[] { UserRole.CENTER_OPERATOR,
                                                                        UserRole.CENTER_MANAGER, UserRole.BRANCH_CUSTODIAN,UserRole.BRANCH_OPERATOR,UserRole.AUDITOR};
        private static readonly ILog log = LogManager.GetLogger(typeof(IssuedCardsReportPage));
        ...
        private void PrepareReportData(DateTime? startDate, DateTime? endDate, string branchOperator)
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "8"));
                ...
                //ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/IssuedCardsReport"; //Passing the Report Path                
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/IssuedCardsReport_2"; //Passing the Report Path                
        ...
        private void LoadBranchOperators(UserRole userRole, int issuerid, string branchid)
        {
            try
            {
                ...
                //{
                //    ddluser.Items.Clear();
                //    ddluser.Items.Add(new ListItem(SessionWrapper.SessionUserName, SessionWrapper.SessionUserId.ToString()));
                //}
