<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true"
    CodeBehind="FeeStatusReport.aspx.cs" Culture="auto:en-US" meta:resourcekey="PageResource"
    UICulture="auto" Inherits="indigoCardIssuingWeb.Reporting.Branches.FeeStatusReport" %>
        ...
        <div class="ContentPanel">
            <div id="pnlDisable" runat="server">
                <div class="ContentHeader">
                    <asp:Label ID="lblheading" runat="server" Text="Fee Status Report" meta:resourcekey="lblheadingResource" />
                </div>            
        <table width="60%">
              <tr>
