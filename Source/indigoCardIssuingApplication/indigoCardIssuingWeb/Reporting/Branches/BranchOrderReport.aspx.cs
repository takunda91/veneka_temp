...
{
    public partial class BranchOrderReport : BasePage
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(BranchOrderReport));
        ...
        private void PrepareReportData()
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "21"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/BranchOrderReport"; //Passing the Report Path                
