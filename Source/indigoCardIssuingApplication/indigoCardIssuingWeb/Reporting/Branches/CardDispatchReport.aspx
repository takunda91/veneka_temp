<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="CardDispatchReport.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.Branches.CardDispatchReport" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="Card Dispatch Report" meta:resourcekey="lblheadingResource" />
            </div>
            <table width="60%">
                  <tr>
