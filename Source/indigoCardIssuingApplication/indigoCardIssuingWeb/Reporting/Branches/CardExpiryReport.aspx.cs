...
{
    public partial class CardExpiryReport : BasePage
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(CardExpiryReport));
        ...
        private void PrepareReportData()
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "19"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/CardExpiryReport"; //Passing the Report Path                
