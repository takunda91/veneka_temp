<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="BranchOrderReport.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.Branches.BranchOrderReport" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="Branch Order Report" meta:resourcekey="lblheadingResource" />
            </div>
            ...
            <table width="60%">
                ...
                <tr>
                    <td colspan="6">
                        <asp:Label ID="Label1" runat="server" Text="Select Date Range" meta:resourcekey="lbldateheadingResource" />
                ...
                <tr>
                    ...
                    <td colspan="4" align="center">
                        <asp:Button ID="btnApplyDateRange" runat="server" Text="Apply" OnClick="btnApplyDateRange_Click"
                            meta:resourcekey="btnApplyDateRangeResource" CssClass="button" Style="width: 100px" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlProduct" runat="server" CssClass="input" />
                    </td>
                </tr>
