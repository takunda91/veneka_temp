...
{
    public partial class CardsInProgressReport : BasePage
    {
        ...
        private void PrepareReportData(DateTime? startDate, DateTime? endDate, string branchOperator)
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "25"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/CardsInProgressReport"; //Passing the Report Path                
