...
{
    public partial class CMSErrorReport : BasePage
    {
        ...
        private void PrepareReportData(DateTime? startDate, DateTime? endDate, string branchOperator)
        {
            ...
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "26"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/CMSERRORReport"; //Passing the Report Path                
