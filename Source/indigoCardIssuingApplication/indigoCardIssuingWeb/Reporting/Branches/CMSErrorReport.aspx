<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true"
    CodeBehind="CMSErrorReport.aspx.cs" Culture="auto:en-US" meta:resourcekey="PageResource"
    UICulture="auto" Inherits="indigoCardIssuingWeb.Reporting.Branches.CMSErrorReport" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="CMS Erorr Report" meta:resourcekey="lblheadingResource" />
            </div>
            <table width="60%">
