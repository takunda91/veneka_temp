<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="CardsInProgressReport.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.Branches.CardsInProgressReport" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="Cards InProgress Report" meta:resourcekey="lblheadingResource" />
            </div>
