...
{
    public partial class CardProductionReport : BasePage
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(CardProductionReport));
        ...
        private void PrepareReportData()
        {
            try
            {
               ...
               string branchid = null, issuer_id = null, product_id=null;
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "20"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/CardProductionReport"; //Passing the Report Path                
