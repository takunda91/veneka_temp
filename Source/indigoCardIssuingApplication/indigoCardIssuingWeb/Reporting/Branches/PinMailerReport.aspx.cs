...
{
    public partial class PinMailerReport : BasePage
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(PinMailerReport));
        ...
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                datepickerFrom.Text = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy");
                datepickerTo.Text = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.DaysInMonth(DateTime.Now.Year, DateTime.Now.Month)).ToString("dd/MM/yyyy");
        ...
        private void PrepareReportData()
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "15"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/PinMailerReport"; //Passing the Report Path                
