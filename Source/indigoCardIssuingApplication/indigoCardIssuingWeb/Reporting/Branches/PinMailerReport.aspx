<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="PinMailerReport.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.Branches.PinMailerReport" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Label ID="lblheading" runat="server" Text="PIN Mailer Report" meta:resourcekey="lblheadingResource" />
            </div>            
