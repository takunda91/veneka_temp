...
{
    public partial class BurnRateReportPage : BasePage
    {
        ...
        private static readonly ILog log = LogManager.GetLogger(typeof(BurnRateReportPage));
        ...
        private void PrepareReportData()
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "24"));
                //objReportParams.Add(new Tuple<string, string>("REPORT_DATE", null));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName +"/BurnRateReport"; //Passing the Report Path                
