<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true"
    CodeBehind="IssuerCardsSummaryReportPage.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.CardCenter.IssuerCardsSummaryReportPage"  culture="auto:en-US" meta:resourcekey="PageResource" uiculture="auto"%>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Literal ID="lblIssuecardSummaryReport" Text="Issued Summary Report" runat="server"  meta:resourcekey="lblIssuecardSummaryReportResource" />
            </div>                 
        <table width="60%">
             <tr>
