...
{
    public partial class SpoilCardSummaryReportPage : BasePage
        {
            ...
            private readonly UserRole[] userRolesForPage = new UserRole[] { UserRole.CENTER_OPERATOR,
                                                                        ...
                                                                        UserRole.AUDITOR};
            private static readonly ILog log = LogManager.GetLogger(typeof(SpoilCardSummaryReportPage));
        ...
        protected void PrepareReportData( DateTime? startDate, DateTime? endDate,string branchid)
        {
            try
            {
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "10"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/SpoilCardsSummaryReport";
