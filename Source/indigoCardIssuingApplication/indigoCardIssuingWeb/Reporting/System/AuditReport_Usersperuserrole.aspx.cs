...
{
    public partial class AuditReport_Usersperuserrole : BasePage
    {
        ...
        private readonly UserRole[] userRolesForPage = new UserRole[] { UserRole.AUDITOR, UserRole.USER_ADMIN };
        private static readonly ILog log = LogManager.GetLogger(typeof(AuditReport_Usersperuserrole));
        ...
        protected void GenerateReport()
        {
            try
            {
                ...
                string branchid = null, issuerid = null, usergroupid = null, roleid = null, userid = null, user_group_id=null;
                ...
                //        usergroupid = int.Parse(ddlusergroup.SelectedValue);
                //    objreportlabel.usergroupname = ddlusergroup.SelectedItem.Text;

                //}
                //else
                //{
                //    objreportlabel.usergroupname = "-ALL-";
                //}
                objReportParams.Add(new Tuple<string, string>("user_group_id", user_group_id));
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "13"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/AuditReport_Usersperuserrole"; //Passing the Report Path                
        ...
        //        if (branchid != null)
        //        {
        //            operators = userMan.GetUsersForBranch(issuerid, int.Parse(branchid), BranchStatus.ACTIVE, 0, UserRole.BRANCH_OPERATOR, username, null, null, 1, 1000);
        //        }
        //        else
        //        {
        ...
        //            {
        //                this.ddluser.Items.AddRange(operatorList.OrderBy(m => m.Value).ToArray());
