<%@ Page Title="" Language="C#" MasterPageFile="~/IndigoCardIssuance.Master" AutoEventWireup="true" CodeBehind="AuditReport_Usergroup.aspx.cs" Inherits="indigoCardIssuingWeb.Reporting.System.AuditReport_UserGroup" %>
    ...
    <div class="ContentPanel">
        <div id="pnlDisable" runat="server">
            <div class="ContentHeader">
                <asp:Literal ID="lblAuditReportUsergroup" Text="Audit Report – User Groups" runat="server" meta:resourcekey="lblInventorySummaryReportResource" />
            </div>
         ...
         <div style="padding-left:300px;padding-top:5px;">
            ...
            <div style="overflow: auto">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana"
                    Font-Size="8pt" WaitMessageFont-Names="Verdana" ShowPrintButton="true"  AsyncRendering="false"
