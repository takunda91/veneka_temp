...
{
    public partial class AuditReport_UserGroup : BasePage
    {
        ...
        private static readonly ILog log = LogManager.GetLogger(typeof(AuditReport_UserGroup));
        ...
        protected void GenerateReport()
        {
            try
            {
               ...
               string branchid = null, issuerid = null,roleid = null;
                ...
                objReportParams.Add(new Tuple<string, string>("reportId", "14"));
                ...
                ReportViewer1.ServerReport.ReportPath = "/" + ReportServerFolderName + "/AuditReport_Usergroup"; //Passing the Report Path                
