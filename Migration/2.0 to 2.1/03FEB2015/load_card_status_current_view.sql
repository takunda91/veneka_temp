...
/****** Object:  View [dbo].[load_batch_status_card_current]    Script Date: 2015/02/04 03:48:14 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT        dbo.cards.card_id, dbo.cards.product_id, dbo.cards.branch_id, dbo.cards.card_number, dbo.cards.card_sequence, dbo.cards.card_index, 
                         ...
                         dbo.cards.sub_product_id, dbo.load_batch_cards.load_batch_id, dbo.load_batch_cards.load_card_status_id, 
